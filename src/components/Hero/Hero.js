...
export default function Hero() {
  return (
    <div className="bg-dark text-white">
      <div className="container mx-auto flex justify-center flex-col items-center text-center py-40 px-5">
        ...
        <div className="flex justify-between items-center py-20">
          <img
            className="w-22 transition-all duration-300 ease-in-out cursor-pointer opacity-40 transform hover:scale-125 hover:opacity-100 px-3"
