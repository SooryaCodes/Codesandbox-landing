...
export default function Navbar() {
  return (
    <>
      <div
        className="flex justify-between items-center h-16 bg-dark relative  shadow-navLine font-mono"
        role="navigation"
      >
        <nav className="container mx-auto flex items-center justify-between  text-light ">
          ...
          <div className="flex items-center justify-end">
            ...
            <Button px="4" py="2" text="Create Sandbox" classes="xl:block hidden mx-4" />
          </div>
        </nav>
      </div>
    </>
